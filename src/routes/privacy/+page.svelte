...
<section>
	<h1>Privacy Policy of LectCheck</h1>
	<p>LectCheck operates the lectcheck.vercel.app website, which provides the SERVICE.</p>

	<p>
		This page is used to inform website visitors regarding our policies with the collection, use,
		and disclosure of Personal Information if anyone decided to use our Service, the LectCheck
		website.
	</p>
	...
	<p>
		...
		which is accessible at lectcheck.vercel.app, unless otherwise defined in this Privacy Policy.
	</p>
	...
	<p>
		...
		computer&apos;s Internet Protocol (&quot;IP&quot;) address, browser version, pages of our
		Service that you visit, the time and date of your visit, the time spent on those pages, and
		other statistics.
	</p>
